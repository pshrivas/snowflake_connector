...
implements com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage {
     ...
     */
     public static com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage init() {
       synchronized(com.informatica.imf.icore.IMFRuntime.getInstance().getIMFRegistryLockObject()) {
          LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: enter 'init()'");
            com.informatica.imf.icore.IMFRuntime imfRuntime = com.informatica.imf.icore.IMFRuntime.getInstance();
          if (imfRuntime.isPackageRegistered(com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage.I_QUALIFIED_NAME)) {
            LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: already initialized");
            return (com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage)
              imfRuntime.getIPackageForName(com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage.I_QUALIFIED_NAME);
          }

          // Create and register package
          CapabilityIPackageImpl theComUnicosolutionAdapterSnowflakev2TableRuntimeCapabilityIPackage = (CapabilityIPackageImpl)
              new com.unicosolution.adapter.snowflakev2.table.runtime.capability.impl.CapabilityIPackageImpl();

          theComUnicosolutionAdapterSnowflakev2TableRuntimeCapabilityIPackage.createPackageContents();



          theComUnicosolutionAdapterSnowflakev2TableRuntimeCapabilityIPackage.initializePackageContents();



          imfRuntime.registerPackage(theComUnicosolutionAdapterSnowflakev2TableRuntimeCapabilityIPackage);

          LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: exit 'init()'");
          return theComUnicosolutionAdapterSnowflakev2TableRuntimeCapabilityIPackage;
      }
    }
    ...
    */
    ...
    public com.informatica.imf.icore.IFactory getFactory() {
       return com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIFactory.I_INSTANCE;
    }
   ...
   private boolean isCreated = false;
    ...
    /**
     ...
     public void createPackageContents() {
         LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: enter 'createPackageContents()'");
         if (this.isCreated) {
           LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: already created");
           return;
         }
         this.isCreated = true;
  ...
  private boolean isInitialized = false;
    ...
    public void initializePackageContents() {
        LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: enter 'initializePackageContents()'");
      ...
      iSetIdentity(getQualifiedName());
        ...
        initClasses();
        setFactory(com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIFactory.I_INSTANCE);
        ...
        LOGGER.log(Level.FINE, "Initialization of com.unicosolution.adapter.snowflakev2.table.runtime.capability.CapabilityIPackage: exit 'initializePackageContents()'");
    }
