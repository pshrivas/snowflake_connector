...
implements com.unicosolution.adapter.snowflakev2.connection.ConnectionIFactory {

    /**
     * The generated Serial Version UID.
     * This is the same as for the 'com.unicosolution.adapter.snowflakev2.connectionIPackageImpl'.
     */
    ...
    public <T> T create(com.informatica.imf.icore.IClass iClass) {
        ...
        switch (((com.informatica.imf.icore.internal.ITypeInternal)iClass).getTypeId()) {
     	    case com.unicosolution.adapter.snowflakev2.connection.impl.ConnectionIPackageImpl.SNOWFLAKE_V2_CONNECT_INFO_EXTENSION:
     	        return (T) createSnowflakeV2ConnectInfoExtension(); 
     	    case com.unicosolution.adapter.snowflakev2.connection.impl.ConnectionIPackageImpl.SNOWFLAKE_V2_CONNECT_INFO:
     	        return (T) createSnowflakeV2ConnectInfo(); 
     	    default:
                throw new com.informatica.core.exception.IllegalArgumentException(
    ...
    public <T> T createProxy(com.informatica.imf.icore.IClass iClass,
        ...
        switch (((com.informatica.imf.icore.internal.ITypeInternal)iClass).getTypeId()) {
            case com.unicosolution.adapter.snowflakev2.connection.impl.ConnectionIPackageImpl.SNOWFLAKE_V2_CONNECT_INFO:
                return (T) createSnowflakeV2ConnectInfoProxy(identity); 
            default:
            throw new com.informatica.core.exception.IllegalArgumentException(
                  com.informatica.imf.ImfMsg.THE_CLASS_type_IS_NOT_A_VALID_CLASSIFIER,
                  iClass.getName());
     ...
     */
     public com.unicosolution.adapter.snowflakev2.connection.SnowflakeV2ConnectInfoExtension createSnowflakeV2ConnectInfoExtension() {
        com.unicosolution.adapter.snowflakev2.connection.SnowflakeV2ConnectInfoExtension snowflakeV2ConnectInfoExtension = new SnowflakeV2ConnectInfoExtensionImpl();
        return snowflakeV2ConnectInfoExtension;
     }
     ...
     */
     public com.unicosolution.adapter.snowflakev2.connection.SnowflakeV2ConnectInfo createSnowflakeV2ConnectInfo() {
        com.unicosolution.adapter.snowflakev2.connection.SnowflakeV2ConnectInfo snowflakeV2ConnectInfo = new SnowflakeV2ConnectInfoImpl();
        return snowflakeV2ConnectInfo;
     }

    /**
     * Creates a proxy instance of SnowflakeV2ConnectInfo IClass.
     * @return a proxy object of type SnowflakeV2ConnectInfo.
     */
     private com.unicosolution.adapter.snowflakev2.connection.SnowflakeV2ConnectInfo createSnowflakeV2ConnectInfoProxy(com.informatica.imf.icore.IIdentity identity) {
        com.unicosolution.adapter.snowflakev2.connection.SnowflakeV2ConnectInfo snowflakeV2ConnectInfo = new SnowflakeV2ConnectInfoImpl(identity);
        return snowflakeV2ConnectInfo;
     }
    ...
    public com.informatica.imf.icore.IPackage getPackage() {
        return com.unicosolution.adapter.snowflakev2.connection.ConnectionIPackage.I_INSTANCE;
    }
}