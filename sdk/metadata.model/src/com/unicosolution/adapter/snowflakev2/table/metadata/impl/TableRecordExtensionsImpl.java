 ...
 * IMF Version: 9.5.0
 * Generation time: 2016-11-22 20:38:01
 */
...
implements com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions {
    /**
     * The generated Serial Version UID.
     */
    private static final long serialVersionUID = -1809631238828225522L;
    ...
    public TableRecordExtensionsImpl() {
     ...
     /**
     * Retrieves the 'tableType' property value for this Object.
     *
     * @see com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions#getTableType()
     * @return the 'tableType' property value for this Object
     */
     ...
     * @see com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions#setTableType(java.lang.String tableType)
     * @param tableType is the new value for property 'tableType'
     */public void setTableType(java.lang.String tableType) {
    		if(this.tableType.equals(tableType)) {
    			return;
    		}
            ...
            java.lang.String oldVal = this.tableType;
            if(tableType == null) {
                tableType = "";
            }
            ...
            if (com.informatica.imf.icore.IMFRuntime.getInstance().isListenerActive()) {
                com.informatica.imf.icore.IMFRuntime.getInstance().getObjectChangeListener().onPropertyChange(
                    this, com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions.Properties.TABLE_TYPE, oldVal, tableType);
            }
        }
    ...
    public java.lang.Object iGet(com.informatica.imf.icore.IProperty iProperty) {
        ...
        case "com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions.tableType":
    ...
    public void iSet(com.informatica.imf.icore.IProperty iProperty, java.lang.Object newValue) {
    	...
    	super.iSet(iProperty,newValue);
        	...
        	switch (((com.informatica.imf.icore.internal.IPropertyInternal) iProperty).getQualifiedName()) {
            case "com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions.tableType":
                this.setTableType((java.lang.String) newValue);
                break;
            default:
                  throw new com.informatica.core.exception.IllegalArgumentException(
    ...
    public void iInverseSet(com.informatica.imf.icore.IProperty iProperty, java.lang.Object newValue) {
    	...
    	super.iInverseSet(iProperty,newValue);
        	...
        	switch (((com.informatica.imf.icore.internal.IPropertyInternal) iProperty).getQualifiedName()) {
            case "com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions.tableType":
               this.tableType = (java.lang.String) newValue;
               break;
            default:
                  throw new com.informatica.core.exception.IllegalArgumentException(
                      com.informatica.imf.ImfMsg.COULD_NOT_SET_PROPERTY_property_FOR_CLASS_class,
    ...
    public String toString() {
        ...
        sb.append("com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions").append('[');
    ...
    public static void initIProperties() {
        PROPERTY_ID = com.unicosolution.adapter.snowflakev2.table.metadata.impl.MetadataIPackageImpl.TABLE_RECORD_EXTENSIONS__TABLE_TYPE;
        		com.unicosolution.adapter.snowflakev2.table.metadata.TableRecordExtensions.Properties.TABLE_TYPE =
        			com.unicosolution.adapter.snowflakev2.table.metadata.MetadataIPackage.I_INSTANCE.getTableRecordExtensionsIClass().getAllProperties(true).get(PROPERTY_ID);
    }
}